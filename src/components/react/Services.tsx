...
export default function Services() {
  return (
    <section
      id="solutions"
      className="py-24 bg-[#1a1f24] relative border border-slate-800"
    >
        ...
        <div className="mb-16 md:flex md:justify-between md:items-end border-l-4 border-red-600 pl-6">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mt-2 uppercase tracking-tight">
              Sectores <span className="text-red-600">Industriales</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {SERVICES.map((service, index) => (
            <motion.div
              ...
              className="group relative h-[500px] border border-slate-800 bg-[#1a1f24] overflow-hidden rounded shadow-2xl"
            >
              {/* Image Background */}
              <div className="absolute inset-0 z-0">
                <img
                  ...
                  className="w-full h-full object-cover transition-transform duration-1000 lg:group-hover:scale-110 lg:filter lg:grayscale group-hover:grayscale-0"
                />
              ...
              <div className="absolute inset-0 z-10 p-8 flex flex-col justify-end">
                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                  ...
                  <p className="text-gray-300 font-light mb-6 lg:opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100 line-clamp-3 leading-relaxed">
                    {service.description}
                  </p>

                  <div className="flex flex-wrap gap-2 mb-6 lg:opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200">
